      ...
      <div className="card rounded-4xl sticky top-20">
        ...
        <div className="body w-full flex flex-col">
          <div className="flex flex-col items-center justify-center">
            ...
            <h1 className="text-md my-3 text-gray-500 font-medium">
              @JunedPothawale
            </h1>
          </div>
          <div className="socialIcon flex space-x-3 justify-center py-5">
            <a className="bg-(--button_card) group border border-gray-900 hover:bg-white w-[15%] transition flex justify-center items-center rounded-full aspect-square cursor-pointer">

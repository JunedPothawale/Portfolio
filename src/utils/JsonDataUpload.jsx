...
export const Education = {
  ...
  list: [
    ...
    },
    {
      ...
      description:
        "Built a strong foundation in software development, algorithms, and database management.Explored core programming concepts through practical projects and teamwork, which inspired my path toward full-stack web development.",
    },
  ],
};
export const Skills = {
...
export const ContactPhoneNumberTo = {
  id: 1,
